...
//                customeAdpater.notifyDataSetChanged();
    ...
    class CustomeAdpater extends BaseAdapter {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            TextView t_likes= convertView.findViewById(R.id.likeCount);
            TextView t_disLikes= convertView.findViewById(R.id.disLikeCount);
                        ...
                        public boolean onMenuItemClick(MenuItem item) {
                            switch (item.getItemId()){
                                ...
                                case R.id.item2:
                                    ...
                                    return true;
                                case R.id.item3:
                                    Toast.makeText(MainActivity.this, "Item3 :)",
...
//
//    public ArrayList<Comment> com_objects ()
//    {
...
//                for(DataSnapshot com_snapshot : dataSnapshot.getChildren())
//                {
//                    Comment c = com_snapshot.getValue(Comment.class);
//                    arrayListComment.add(c);
//                }
//            }
//
//            @Override
